...
> **Note** Application Service Adapter supports the cf CLI commands listed below by providing a subset of [the endpoints the v3 CF API](https://v3-apidocs.cloudfoundry.org/) through its API server.
